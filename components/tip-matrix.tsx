...
export function TipMatrix({
  ...
  const headerBase = "sticky top-0 md:top-[96px] z-10 px-2 py-2 whitespace-nowrap text-white transform-gpu";
  ...
  return (
    <main>
      ...
      <div className="fixed inset-x-0 top-[80px] md:top-[56px] z-[45] bg-white transform-gpu">
